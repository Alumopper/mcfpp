...
public class mcfppParser extends Parser {
	...
	public static final int
		...
		T__45=46, Identifier=47, InsideClass=48, ClassIdentifier=49, INT=50, DECIMAL=51, 
		VEC=52, WS=53, COMMENT=54, LINE_COMMENT=55;
	public static final int
		...
		RULE_var = 26, RULE_identifierSuffix = 27, RULE_selectorSuffix = 28, RULE_selector = 29, 
		RULE_superSuffix = 30, RULE_arguments = 31, RULE_functionBody = 32, RULE_statement = 33, 
		RULE_block = 34, RULE_selfAddOrMinusExpression = 35, RULE_forControl = 36, 
		RULE_forInit = 37, RULE_forUpdate = 38, RULE_forVariableDeclaration = 39, 
		RULE_expressionList = 40, RULE_type = 41, RULE_number = 42, RULE_className = 43;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"basicExpression", "castExpression", "primary", "var", "identifierSuffix", 
			"selectorSuffix", "selector", "superSuffix", "arguments", "functionBody", 
			"statement", "block", "selfAddOrMinusExpression", "forControl", "forInit", 
			"forUpdate", "forVariableDeclaration", "expressionList", "type", "number", 
			"className"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"')'", "'new'", "'='", "','", "'?'", "':'", "'||'", "'&&'", "'=='", "'!='", 
			"'<='", "'>='", "'<'", "'>'", "'+'", "'-'", "'*'", "'/'", "'%'", "'!'", 
			"'this'", "'super'", "'['", "']'", "'.'", "'if'", "'else'", "'for'", 
			"'while'", "'do'", "'try'", "'store'", "'++'", "'--'", "'int'", "'float'", 
			"'string'", "'bool'", "'decimal'", null, null, null, null, null, "'vec'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"InsideClass", "ClassIdentifier", "INT", "DECIMAL", "VEC", "WS", "COMMENT", 
			"LINE_COMMENT"
		};
	}
	...
	public final ClassDeclarationContext classDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 980764371976256L) != 0) {
				{
				{
				setState(113);
				classMember();
	...
	public final FunctionDeclarationContext functionDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & 980764371976192L) != 0) {
				{
				setState(124);
				parameterList();
				}
	...
	public final IdentifierSuffixContext identifierSuffix() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_identifierSuffix);
		try {
			setState(288);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public static class SelectorSuffixContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof mcfppListener ) ((mcfppListener)listener).enterSelectorSuffix(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof mcfppListener ) ((mcfppListener)listener).exitSelectorSuffix(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof mcfppVisitor ) return ((mcfppVisitor<? extends T>)visitor).visitSelectorSuffix(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final SelectorSuffixContext selectorSuffix() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_selectorSuffix);
		try {
			setState(294);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public static class SuperSuffixContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof mcfppListener ) ((mcfppListener)listener).enterSuperSuffix(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof mcfppListener ) ((mcfppListener)listener).exitSuperSuffix(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof mcfppVisitor ) return ((mcfppVisitor<? extends T>)visitor).visitSuperSuffix(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ArgumentsContext arguments() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & 3518438148407936L) != 0) {
				{
				setState(317);
				expressionList();
				}
	...
	public final FunctionBodyContext functionBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 1122025846341636L) != 0) {
				{
				{
				setState(322);
				statement();
	...
	public final ForControlContext forControl() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & 4499202520384128L) != 0) {
				{
				setState(385);
				forInit();
				}
